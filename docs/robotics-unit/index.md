...
Welcome to intelligent robotics. We are going to attempt to teach you everything we know in 12 weeks. Buckle up!
...
2. What should the state of our robot be? It's position, velocity, orientation? The position, velocity and orientation of everything in the world? What is the right *representation* for a given task? What is the position and orientation of a banana? How do you peel a banana?  We are going to deal with some big existential questions this semester.
3. How can I extract information from the world? What sensors should I use? How to I combine uncertain information? 
...
2. Robot control: We will look at specific controller designs and ways to find policies for a range of standard robots. 
3. Robot Modelling: We will look at some standard dynamics and *kinematic* models of robots and how we model these, starting with ground vehicles? 
4. SLAM part 1 (Localisation): We will look at a state estimation problem, where is our robot in the world?  
...
6. Robot vision and imitation learning: We will briefly look at cameras as a sensor, but also look at ways to *learn* policies from *demonstrations*.
